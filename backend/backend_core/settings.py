...
Generated for initial project bootstrapping.
"""
...
MIDDLEWARE = [
    'corsheaders.middleware.CorsMiddleware',  # Only one CORS middleware entry
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default=EMAIL_HOST_USER or 'no-reply@uniroute.lk')
