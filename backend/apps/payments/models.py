...
class UniversityAdPayments(models.Model):
    """Payment records for university advertisements."""
    payment_id = models.AutoField(primary_key=True)
    ad = models.ForeignKey('universities.UniversityAd', models.DO_NOTHING)
    amount = models.DecimalField(max_digits=10, decimal_places=2)
    ...
    class Meta:
        managed = True
        db_table = 'university_ad_payments'
