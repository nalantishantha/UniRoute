...
const WS_PROTOCOL = import.meta.env.VITE_API_URL?.startsWith('https') ? 'wss' : 'ws';
const WS_HOST = import.meta.env.VITE_API_URL?.replace('https://', '').replace('http://', '') || 'localhost:8000';
