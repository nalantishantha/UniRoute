...
import PreMentorInternshipGrid from './PreMentorInternshipGrid';
import PreMentorInternshipModal from './PreMentorInternshipModal';

const PreMentorInternshipOpportunities = () => {
...
export default PreMentorInternshipOpportunities;