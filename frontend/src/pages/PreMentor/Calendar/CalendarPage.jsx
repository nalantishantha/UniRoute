    ...
    >
      ...
      <div className="border-b border-neutral-light-grey">
        <nav className="flex space-x-8">
          <button
            ...
            className={`py-2 px-1 border-b-2 font-medium text-sm transition-colors ${activeTab === "calendar"
          ...
          <button
            ...
            className={`py-2 px-1 border-b-2 font-medium text-sm transition-colors ${activeTab === "availability"
              ? "border-primary-600 text-primary-600"
              : "border-transparent text-neutral-grey hover:text-neutral-black hover:border-neutral-light-grey"
              }`}
          >
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center justify-center w-12 h-12 bg-info/20 rounded-xl">
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-1 text-sm text-success">+0.2 this month</p>
              </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  {loading && (
                    <div className="flex items-center text-sm text-neutral-grey">
                      <div className="w-4 h-4 mr-2 border-b-2 rounded-full animate-spin border-primary-400"></div>
                      Loading...
                    </div>
                  )}
                </div>
              ...
              <CardContent>
                {loading ? (
                  <div className="py-16 text-center">
                    <div className="inline-block w-12 h-12 mb-4 border-b-2 rounded-full animate-spin border-primary-400"></div>
                  ...
                  <>
                    ...
                    <div className="p-4 mt-4 border rounded-lg bg-gradient-to-r from-neutral-silver/20 to-neutral-silver/40 border-neutral-light-grey">
                      <div className="flex flex-wrap items-center justify-between gap-4 text-sm">
                        <div className="flex flex-wrap items-center gap-6">
                          <div className="flex items-center">
                            <div className="w-5 h-5 mr-2 bg-green-200 border-2 border-green-400 rounded shadow-sm"></div>
                            <span className="font-semibold text-neutral-black">
                              Available Tutoring Slots
                            </span>
                          </div>
                          <div className="flex items-center">
                            <div className="w-5 h-5 mr-2 bg-pink-200 border-2 border-pink-400 rounded shadow-sm"></div>
                            <span className="font-semibold text-neutral-black">
                        ...
                        {events.length > 0 && (
                          <div className="px-3 py-1 font-semibold bg-white border rounded-full text-neutral-black border-neutral-light-grey">
              ...
              <CardContent className="space-y-4">
                {loading ? (
                  <div className="py-8 text-center">
                    <div className="inline-block w-8 h-8 border-b-2 rounded-full animate-spin border-primary-400"></div>
                    ...
                    {tutorAvailability.filter((s) => s.is_active).length >
                      0 && (
                        <div className="space-y-2">
                          <h4 className="flex items-center text-sm font-semibold text-neutral-grey">
                    ...
                    {events
                      ...
                      .map((event, index) => (
                        <motion.div
                          ...
                          animate={{ opacity: 1, x: 0 }}
                          transition={{ delay: index * 0.1 }}
                          className={`p-4 border rounded-lg ${event.type === "mentoring"
                        ...
                        >
                          <div className="flex items-start justify-between mb-2">
                            ...
                            <span
                              className={`text-xs px-2 py-1 rounded-full whitespace-nowrap ${event.status === "confirmed" ||
                          ...
                          <div className="flex items-center space-x-4 text-sm text-neutral-grey">
                            ...
                            <div
                              className={`text-xs font-medium ${event.type === "mentoring"
                                ? "text-blue-700"
                                : "text-green-700"
                                }`}
                            >
      ...
      {activeTab === "availability" && (
        <div className="space-y-6">
          ...
          <div>
            {/* <h2 className="mb-4 text-xl font-bold text-neutral-black">
          ...
          {/* Divider */}
          <div className="my-8 border-t border-neutral-light-grey"></div>
          ...
          <div>
            ...
            {tutorId ? (
              ...
              <div className="py-8 text-center">
                <div className="inline-block w-8 h-8 mb-4 border-b-2 rounded-full animate-spin border-primary-400"></div>
                <p className="text-neutral-grey">
