...
import { University, Mail, Lock, Eye, EyeOff, ArrowLeft, Building, Phone, CheckCircle, AlertCircle, MapPin, FileText, Globe } from 'lucide-react';

const UniversityRegisterPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log('Sending university registration data:', registrationData);

      // Note: You'll need to create this endpoint in your backend
      const response = await fetch('http://127.0.0.1:8000/api/accounts/register/university/', {
        method: 'POST',
        headers: {
      ...
      if (data.success) {
        ...
        // Don't navigate immediately for university registration as it needs approval
        setTimeout(() => {
          navigate('/');
        }, 4000);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#F3E5F5] to-[#E1BEE7] flex flex-col">
      {/* Header */}
      <div className="bg-white/95 backdrop-blur-md border-b border-[#E1BEE7]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <Link to="/register" className="flex items-center space-x-2 text-[#7B1FA2] hover:text-[#4A148C] transition-colors">
              <ArrowLeft className="h-5 w-5" />
              <span className="font-medium">Back to Role Selection</span>
            </Link>
            
            <div className="flex items-center space-x-2">
              <University className="h-8 w-8 text-[#7B1FA2]" />
              <span className="font-bold text-2xl text-[#7B1FA2]">UniRoute</span>
            </div>
      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8 py-12">
        <div className="max-w-2xl w-full">
          <div className="bg-white rounded-2xl shadow-xl p-8 border border-[#E1BEE7]">
            {/* Header */}
            <div className="text-center mb-8">
              <div className="bg-[#F3E5F5] w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                <University className="h-8 w-8 text-[#7B1FA2]" />
              </div>
              ...
              <p className="text-[#717171]">
                Partner with us to showcase your programs to students
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  <Building className="absolute left-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-[#717171]" />
                  <input
                    type="text"
                    id="universityName"
                    name="universityName"
              ...
              {/* Established Year */}
              <div>
                <label htmlFor="establishedYear" className="block text-sm font-medium text-[#263238] mb-2">
                  Year Established
                </label>
                <input
                  type="number"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <textarea
                    ...
                    onChange={handleInputChange}
                    rows={4}
                    className="w-full pl-10 pr-4 py-3 border border-[#E1BEE7] rounded-xl focus:ring-2 focus:ring-[#7B1FA2] focus:border-[#7B1FA2] transition-all bg-white resize-none"
                    placeholder="Brief description of your university, programs offered, and what makes you unique..."
                    disabled={isLoading}
                  />
                </div>
              </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      className="w-full pl-10 pr-12 py-3 border border-[#E1BEE7] rounded-xl focus:ring-2 focus:ring-[#7B1FA2] focus:border-[#7B1FA2] transition-all bg-white"
                    ...
                    <button
                      ...
                      className="absolute right-3 top-1/2 transform -translate-y-1/2 text-[#717171] hover:text-[#7B1FA2] transition-colors"
                      disabled={isLoading}
                    >
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  <input
                    ...
                    onChange={handleInputChange}
                    className="h-4 w-4 text-[#7B1FA2] border-[#E1BEE7] rounded focus:ring-[#7B1FA2] mt-0.5"
                    required
                    disabled={isLoading}
                  />
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <label htmlFor="receiveUpdates" className="text-sm text-[#717171]">
                    I want to receive updates about platform features and student engagement opportunities
                  </label>
                </div>
              </div>
              ...
              <button
                type="submit"
                disabled={isLoading}
                className={`w-full py-3 px-4 rounded-xl font-semibold focus:ring-2 focus:ring-[#7B1FA2] focus:outline-none transition-all transform hover:-translate-y-0.5 hover:shadow-lg ${
                  isLoading 
                    ? 'bg-[#B0B0B0] cursor-not-allowed text-white' 
                    : 'bg-[#7B1FA2] hover:bg-[#4A148C] text-white'
                }`}
              >
                {isLoading ? (
            ...
            {/* Additional Info */}
            <div className="mt-6 p-4 bg-[#F3E5F5] rounded-xl">
              <p className="text-sm text-[#7B1FA2] text-center">
                <strong>Note:</strong> University registrations require manual approval. We will review your application and contact you within 24-48 hours.
              </p>
            </div>
