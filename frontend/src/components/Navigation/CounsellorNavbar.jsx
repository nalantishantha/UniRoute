  ...
  const getPageName = () => {
    ...
    switch (path) {
      case "/counsellor/dashboard":
        return "Dashboard";
      case "/counsellor/mentoring":
        return "Mentoring";
      case "/counsellor/calendar":
        return "Calendar";
      case "/counsellor/earnings":
        return "Earnings";
      case "/counsellor/feedback":
        return "Feedback";
      case "/counsellor/profile":
        return "Profile";
      case "/counsellor/settings":
        return "Settings";
      default:
                  ...
                  <div className="py-2">
                    ...
                    <button
                      onClick={() => {
                        ...
                        window.location.href = "/counsellor/settings";
                      }}
                      className="flex items-center w-full px-4 py-2 space-x-3 text-sm transition-colors duration-200 text-neutral-black hover:bg-neutral-silver/50"
                    >
