...
// CHANGED: Navigation for COMPANY USERS - Routes to user pages (no admin functionality)
const navigation = [
  {
    name: "Dashboard",
    href: "/company/dashboard", // Routes to company user dashboard
    icon: LayoutDashboard,
  },
  {
    name: "Courses",
    href: "/company/courseuser", // Routes to company user courses
    icon: BookOpen,
  },
  {
    name: "Internships",
    href: "/company/internshipuser", // Routes to company user internships
    icon: BriefcaseIcon,
  },
  {
    name: "Announcements",
    href: "/company/announcementuser", // Routes to company user announcements
    icon: MessageSquare,
  },
  // NOTE: NO admin features like "Add Course", "Manage Internships", etc.
];
...
export default function CompanyUserSidebar({ isOpen, setIsOpen }) {
  ...
  const handleLogout = () => {
    // Remove token or any auth info (customize as needed)
          ...
          <div className="flex items-center justify-between p-6 border-b border-primary-700/50">
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-primary-200">Company Student</p> {/* CHANGED: Different subtitle for company users */}
              </div>
            </motion.div>
