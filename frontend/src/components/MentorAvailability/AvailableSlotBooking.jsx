...
const AvailableSlotBooking = ({ mentorId, mentorName, onBookingSuccess }) => {
  ...
  const fetchAvailableSlots = useCallback(async () => {
    try {
      setLoading(true);
      const response = await fetch(`/api/mentoring/available-slots/${mentorId}/`);
  ...
  const handleBookingSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`/api/mentoring/requests/${mentorId}/`, {
        method: 'POST',
        headers: {
      ...
      if (data.status === 'success') {
        setMessage({ type: "success", text: "Booking request sent successfully! The mentor will review and approve your request." });
        resetBookingForm();
      ...
      <CardContent className="space-y-6">
        ...
        {loading && !showBookingForm ? (
          ...
          <div className="text-center py-8 text-neutral-grey">
            ...
            <p className="text-sm">Please check next week or contact the mentor directly.</p>
          </div>
        ) : (
                  ...
                  <form onSubmit={handleBookingSubmit} className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        placeholder="e.g., Computer Science degree advice"
...
export default AvailableSlotBooking;
