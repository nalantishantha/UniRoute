                  ...
                  >
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="mt-1">
                          <span
                            className={`text-xs px-2 py-0.5 rounded-full ${chat.type === "tutoring"
            ...
            <div className="flex-1 flex flex-col">
              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-4">
                {mockMessages.map((msg) => (
                  ...
                  >
                    <div
                      className={`max-w-xs lg:max-w-md px-4 py-2 rounded-lg ${msg.isMe
                    ...
                    >
                      ...
                      <p
                        className={`text-xs mt-1 ${msg.isMe ? "text-white/80" : "text-neutral-grey"
                          }`}
                      >
                        {msg.timestamp}
                      </p>
